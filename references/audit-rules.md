...
- Calculate monthly reimbursable amount as the lesser of invoice amount and monthly standard. Enter the final monthly amount, not the uncapped invoice total.
